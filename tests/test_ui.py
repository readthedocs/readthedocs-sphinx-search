...
@pytest.mark.sphinx(srcdir=TEST_DOCS_SRC)
def test_position_of_search_modal(selenium, app, status, warning):
    """Test if the search modal is in middle of the page."""
    app.build()
    path = app.outdir / 'index.html'
    ...
    with InjectJsManager(path, SCRIPT_TAG) as _:
        ...
        for window_size in window_sizes:
            selenium.set_window_size(*window_size)
            ...
            ), 'difference between calculated and actual x coordinate should not be greater than 10 pixel'
            ...
            ), 'difference between calculated and actual y coordinate should not be greater than 10 pixel'
